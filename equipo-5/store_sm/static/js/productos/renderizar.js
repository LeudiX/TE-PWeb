  ...
  const tupla = `
                ...
                <td>
                    <div class="d-flex align-items-center gap-2">
                        <input type="checkbox" class="product-checkbox form-check-input seleccionar" data-id="${item.id}">
                        ...
                        <button class="btn btn-sm btn-light row-delete eliminar" data-id="${item.id}" title="Eliminar"><i class="fas fa-trash"></i></button>
                    </div>
                </td>`;
  return tupla;
}
